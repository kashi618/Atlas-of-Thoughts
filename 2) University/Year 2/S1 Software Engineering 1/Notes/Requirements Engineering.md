...
Derives the system requirements through interaction with the stakeholders/customers, and potential users

### Specification
Gathered requirements are written in a formal and technical documentation

### Validation
The requirements are then checked for realism, consistency, and completeness
