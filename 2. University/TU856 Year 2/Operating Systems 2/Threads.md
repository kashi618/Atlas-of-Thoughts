...
## Thread Scheduling
Due to threads sharing resources and being atomic, they require precise [[Thread and Process Synchronization|scheduling]] to avoid conflict when accessing these resources
